...
If you use GRIPS in your research, please cite it — see
[`CITATION.cff`](./CITATION.cff) for the current citation, or use the
"Cite this repository" button on the GitHub repo page. A versioned DOI via
Zenodo will be added here once the first release is published.
